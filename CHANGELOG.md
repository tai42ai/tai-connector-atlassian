...
All notable changes to `tai-connector-atlassian` are documented here; the format follows
...
- Atlassian OAuth 2.0 (3LO) connector descriptor for Jira, Confluence, and
  Compass, registered through the `tai_app` handle. All three sub-services use
